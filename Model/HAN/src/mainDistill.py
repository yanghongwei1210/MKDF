...
def main():
    ...
    rate=0.1
    adjsS, id_nameS, featuresS = load_data_distill(args, args.nodeS, args.linkS, args.configS, list(map(lambda x: int(x), args.metaS.split(','))),distillRate=rate)
    ...
    save_model_path = "/home/user/桌面/Ljx/MKDF/Model/HAN/DBLP_ABtoC/DBLP_atoc22socre_tensor(0.7470)model.pkl"
    ...
    for epoch in range(args.epochs):
        ...
        if test_accuracy[ii] > best_target_acc:
            ...
            print(line)
            save_model_path = "/home/user/桌面/Ljx/MKDF/Model/HAN/distil_path/DBLP_atoc" +str(rate)+ str(best_epoch) + "distillmodel.pkl"

...
data_folder, model_folder = '/home/user/桌面/Ljx/MKDF/Data', '/home/user/桌面/Ljx/MKDF/Model'
emb_file, record_file = 'emb.dat', 'record.dat'
link_test_file, label_test_file, label_file = 'link.dat.test', 'labelall.dat', 'labelall.dat'
...
#                         choices=['DBLP','Freebase','PubMed','ACM','Yelp'])
